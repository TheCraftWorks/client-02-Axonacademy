      ...
      {top3.length > 0 && (
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
            {/* Rank 2 (Silver) */}
            {rank2 ? (
              <div className={`p-4 rounded-3xl border flex flex-col items-center text-center relative transition-all order-2 md:order-1 ${isDark
                ...
                <div className={`w-14 h-14 rounded-2xl border-2 flex items-center justify-center font-display font-black text-lg mt-2 ${isDark ? "bg-slate-400/20 border-slate-300 text-slate-200" : "bg-slate-100 border-slate-300 text-slate-800"
                  }`}>
            ...
            {/* Rank 1 (Gold) */}
            {rank1 && (
              <div className={`p-5 rounded-3xl border-2 flex flex-col items-center text-center relative transition-all order-1 md:order-2 shadow-lg ${isDark
                ...
                <div className={`mt-3 flex items-center gap-1.5 text-[10px] font-black px-2.5 py-1 rounded-full border ${isDark
            ...
            {/* Rank 3 (Bronze) */}
            {rank3 ? (
              <div className={`p-4 rounded-3xl border flex flex-col items-center text-center relative transition-all order-3 ${isDark
